...
namespace LetsGoExplore
{
    ...
    public static class ThingDefOfVanilla
    {
        ...
        public static ThingDef Apparel_PsychicShockLance;

        public static ThingDef Apparel_PsychicInsanityLance;
    ...
    public static class SiteDefOf
    {
        ...
        public static SitePartDef AmbrosiaAnimalsLGE;

        public static SitePartDef ShipCoreStartupLGE;

        public static SitePartDef PrisonCampLGE;
