...
namespace LetsGoExplore
{
    ...
    public class SymbolResolver_LostCityBaseLGE : SymbolResolver
    {
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            resolveParams.chanceToSkipWallBlock = 0.38f; //deafult value: 0.38
    ...
    public class SymbolResolver_FalloutShelterLGE : SymbolResolver
    {
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            resolveParamsCryoCaskets.podContentsType = PodContentsType.Empty;
            if (Rand.Chance(0.8f))
            {
                //resolveParamsCryoCaskets.podContentsType = PodContentsType.AncientHostile;
            }
    ...
    public class SymbolResolver_ToxicFalloutCityBaseLGE : SymbolResolver
    {
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            //Spawn shelters
            int shelterCount = Rand.RangeInclusive(5, 6); //5-6 default value
    ...
    public class SymbolResolver_ScatterFalloutVictimsLGE : SymbolResolver
    {
        public override void Resolve(ResolveParams rp)
        {
            ...
            for (int i = 0; i < corpseCount; i++)
            {
                PawnGenerationRequest request = new PawnGenerationRequest(DefsOfLGE.CityDwellerLGE, Faction.OfAncients, PawnGenerationContext.NonPlayer, -1, canGeneratePawnRelations: true, forceGenerateNewPawn: true, colonistRelationChanceFactor: 1f);
                Pawn pawn = PawnGenerator.GeneratePawn(request);
