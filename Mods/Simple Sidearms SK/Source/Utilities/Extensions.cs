...
namespace PeteTimesSix.SimpleSidearms
{
    public static class Extensions
    {
        ...
        public static bool isTool(this ThingDefStuffDefPair possibleTool)
        {
            ...
            if (possibleTool.thing.modExtensions != null && !possibleTool.thing.modExtensions.Where(e => e.GetType().FullName == "SurvivalToolsLite.SurvivalToolProperties" ||
            e.GetType().FullName == "SurvivalToolsLite.SurvivalToolHelper").EnumerableNullOrEmpty())
                return true;
        ...
        public static bool isToolNotWeapon(this ThingDefStuffDefPair possibleTool)
        {
            if (
                ...
                (possibleTool.thing.modExtensions != null &&
                !possibleTool.thing.modExtensions.Where(e => e.GetType().FullName == "SurvivalToolsLite.SurvivalToolProperties" || 
                e.GetType().FullName == "SurvivalToolsLite.SurvivalToolHelper").EnumerableNullOrEmpty())
                )
            {
                return true;
