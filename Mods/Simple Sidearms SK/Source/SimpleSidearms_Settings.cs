...
namespace PeteTimesSix.SimpleSidearms
{
    ...
    public class SimpleSidearms_Settings : ModSettings
    {
        ...
        public bool ToolAutoSwitchBack;
        public bool CanSetToolsAsFavourites;
        ...
        public bool StopOtherModsFromChangingFavourites;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref ToolAutoSwitchBack, "ToolAutoSwitchBack", defaultValue: true);
            Scribe_Values.Look(ref CanSetToolsAsFavourites, "CanSetToolsAsFavourites", defaultValue: true); 
            ...
            Scribe_Values.Look(ref StopOtherModsFromChangingFavourites, "StopOtherModsFromChangingFavourites", defaultValue: true);
                ...
                case OptionsTab.Automation:
                    {
                        ...
                        subsection.CheckboxLabeled("ToolAutoSwitch_title".Translate(), ref ToolAutoSwitchBack, "ToolAutoSwitch_desc".Translate(), onChange: onChange);
                        subsection.CheckboxLabeled("CanSetToolsAsFavourites_title".Translate(), ref CanSetToolsAsFavourites, "CanSetToolsAsFavourites_desc".Translate(), onChange: onChange); 
                        ...
                        subsection.CheckboxLabeled("StopOtherModsFromChangingFavourites_title".Translate(), ref StopOtherModsFromChangingFavourites, "StopOtherModsFromChangingFavourites_desc".Translate(), onChange);
        ...
        {
            ToolAutoSwitchBack = true;
            CanSetToolsAsFavourites = true;
            OptimalMelee = true;
            CQCAutoSwitch = true;
            CQCTargetOnly = false;
            RangedCombatAutoSwitch = true;
            StopOtherModsFromChangingFavourites = true;
