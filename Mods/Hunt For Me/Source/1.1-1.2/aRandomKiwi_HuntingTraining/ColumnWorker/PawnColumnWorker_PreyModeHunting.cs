...
{
    class PawnColumnWorker_PreyModeHunting : PawnColumnWorker_Checkbox
    {
        ...
        protected override bool GetValue(Pawn pawn)
        {
            if (pawn.TryGetComp<Comp_Hunting>() != null)
                return pawn.TryGetComp<Comp_Hunting>().huntingPreyMode;
            else
                return false;
        }
        ...
        {
            if (pawn.TryGetComp<Comp_Hunting>() != null)
                pawn.TryGetComp<Comp_Hunting>().huntingPreyMode = value;
        }
    }
}
