...
namespace CommonMisc
{
    ...
    public class Radar
    {
        ...
        {
            // LINQ version
            return Find.MapPawns.AllPawnsSpawned.Where(p => p.HostileTo(Faction.OfColony) && !p.InContainer && p.Position.InHorDistOf(Position, Distance));
        }
        /// <summary>
        /// Find enemy pawns in reach and return a list
        /// </summary>
        ...
        {
            // LINQ version
            return Find.MapPawns.AllPawnsSpawned.Where(p => p.HostileTo(Faction.OfColony));
        }
        /// <summary>
        ...
        public static IEnumerable<Pawn> FindFriendlyPawns(IntVec3 Position, float Distance)
        {
            ...
            if (pawns == null)
                ...
                return pawns.Where(p => !p.InContainer && !p.Faction.HostileTo(Faction.OfColony) && !p.RaceProps.Animal && !p.IsColonist && !p.IsPrisonerOfColony);
        }        /// <summary>
        ...
        public static IEnumerable<Pawn> FindFriendlyPawns()
        {
            ...
            if (pawns == null)
                ...
                return pawns.Where(p => !p.InContainer && !IsHostile(p, Faction.OfColony) && !p.RaceProps.Animal && !p.IsColonist && !p.IsPrisonerOfColony);
        }
        ...
        public static IEnumerable<Pawn> FindColonyAnimals(IntVec3 Position, float Distance)
        {
            ...
            if (pawns == null)
                ...
                return pawns.Where(p => !p.InContainer && !p.Dead && p.RaceProps.Animal && p.Faction == Faction.OfColony);
        }        /// <summary>
