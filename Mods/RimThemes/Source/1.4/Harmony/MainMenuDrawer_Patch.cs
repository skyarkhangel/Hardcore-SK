...
namespace aRandomKiwi.RimThemes
{
    ...
    {
        public static bool isRussian => LanguageDatabase.activeLanguage.folderName == "Russian-SK" || LanguageDatabase.activeLanguage.folderName == "Russian";

        internal static Texture2D SK_IconWorld;
        internal static Texture2D SK_IconSK;
        internal static Texture2D SK_IconGithub;
        internal static Texture2D SK_IconVK;
        internal static Texture2D SK_IconDiscord;
        internal static Texture2D SK_IconPatreon;
