...
{
  public class Verb_ShootAVG : Verb_LaunchProjectile
  {
    private static readonly SoundDef GAU8Shoot = SoundDef.Named("GAU8Shoot");
    ...
    {
      base.WarmupComplete();
      SoundStarter.PlayOneShot(Verb_ShootAVG.GAU8Shoot, (SoundInfo)this.caster.Position);
