...
namespace SK_AMR
{
    public class Building_AntimatterReactor : Building
    {
        ...
        private string FramePath = "Things/Building/PlasmaBigGen/PlasmaBigGenF";
        private string FramePath2 = "Things/Building/PlasmaBigGen/PlasmaBigGenVF";
            ...
            if (!this.CanBurnNow)
            {
                ...
                if (anyAnimation <= 0)
                {
                    ...
                    if (this.burnDelay <= 0)
                    {
                        ...
                        this.powerComp.PowerOutput = 30000f;
                        this.burnDelay = 500;
                    }
                }
        }
