    ...
    public class Building_HadronCollider : Building
    {
        ...
        private Thing FuelInHopper
        {
            get
            {
                ...
                ThingDef thingdef2 = ThingDef.Named("HadronColliderFeeder");
                foreach (IntVec3 current in GenAdj.CellsAdjacentCardinal(this))
                {
                    Thing thing = null;
                    Thing thing2 = null;
        ...
        public IEnumerable<MatterResourceDef> ResourceList()
        {
            return DefDatabase<MatterResourceDef>.AllDefs;
        }
