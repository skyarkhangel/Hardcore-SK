...
namespace SK_OR
{
    public class Building_OilRefinery : Building
    {
        ...
        public Building AnyAdjacentHopper
        {
            get
            {
                ThingDef thingDef = ThingDef.Named("OilRefinery");
        ...
        private Thing FuelInHopper
        {
            get
            {
                ThingDef thingdef = ThingDef.Named("CrudeOil");
                ThingDef thingdef2 = ThingDef.Named("OilFeeder");
                foreach (IntVec3 current in GenAdj.CellsAdjacentCardinal(this))
                {
                    Thing thing = null;
                    Thing thing2 = null;
        ...
        public IEnumerable<ChemicalResourceDef> ResourceList()
        {
            return DefDatabase<ChemicalResourceDef>.AllDefs;
        }
