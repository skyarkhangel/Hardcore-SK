...
{
    public class ItemRAD : ThingWithComps
    {
        ...
        public CompGlower compGlowerItemRAD;

        public override void SpawnSetup()
        {
            base.SpawnSetup();
            this.compGlowerItemRAD = this.GetComp<CompGlower>();
            this.compGlowerItemRAD.Lit = true;
        ...
        {
            ThingDef_ItemRAD thingDefItemRAD = (ThingDef_ItemRAD)this.def;
            this.damageAppliedMin = thingDefItemRAD.DamageAppliedMin;
            this.damageAppliedMax = thingDefItemRAD.DamageAppliedMax;
            this.damageCounterStart = thingDefItemRAD.DamageApplyCounter;
            this.damageAppliedSelfMin = thingDefItemRAD.DamageAppliedSelfMin;
            this.damageAppliedSelfMax = thingDefItemRAD.DamageAppliedSelfMax;
            this.damageSelfCounterStart = thingDefItemRAD.DamageApplySelfCounter;
            this.damageDefName = thingDefItemRAD.DamageDefName;
        }
        ...
        private void CheckDamageRange()
        {
            if ((double)this.damageRange >= 0.0)
                return;
            this.damageRange = this.compGlowerItemRAD.props.glowRadius;
        }
    }
}
