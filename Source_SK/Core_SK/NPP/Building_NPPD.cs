...
namespace SK_NPP
{
    public class Building_NPPD : Building
    {
        ...
        public CompGlower compGlowerNPPD;

        public override void SpawnSetup()
        {
            base.SpawnSetup();
            this.compGlowerNPPD = this.GetComp<CompGlower>();
            this.compGlowerNPPD.Lit = true;
        ...
        {
            ThingDef_NPPD thingDefNPPD = (ThingDef_NPPD)this.def;
            this.damageAppliedMin = thingDefNPPD.DamageAppliedMin;
            this.damageAppliedMax = thingDefNPPD.DamageAppliedMax;
            this.damageCounterStart = thingDefNPPD.DamageApplyCounter;
            this.damageAppliedSelfMin = thingDefNPPD.DamageAppliedSelfMin;
            this.damageAppliedSelfMax = thingDefNPPD.DamageAppliedSelfMax;
            this.damageSelfCounterStart = thingDefNPPD.DamageApplySelfCounter;
            this.damageDefName = thingDefNPPD.DamageDefName;
        }
        ...
        private void CheckDamageRange()
        {
            if ((double)this.damageRange >= 0.0)
                return;
            this.damageRange = this.compGlowerNPPD.props.glowRadius;
        }
    }
}
